...
async function main() {
    ...
    await hardhatGovernor.execute([process.env.NFT_CONTRACT_ADDRESS],[0],[mintCalldata], descriptionHash);
    
  
    //console.log("Balance of voted member: ", await hardhatToken.balanceOf(process.env.MEMBER_VOTED_PUBLIC_KEY));
}
